...
<html lang="en">
  ...
  <body>
    ...
    <div class="navbar">
      ...
      <form id="medicalForm"  action="addmedicalprofileproc.php" method="GET">

        <h2 style="margin-left:80px;">Add Patient Medical Profile</h2><br>

        <p class="intro">Enter all necessary fields</p>
        <input class="nav" type="number" id="patient_id" name="patient_id" placeholder="Enter Patient ID"  required><br><br>
        <input class="nav" type="text" id="vaccinations" name="vaccinations" placeholder="Enter Vaccinations Gotten"  required><br><br>
        <input class="nav"type="text"  id="fullBloodCount" name="fullBloodCount" placeholder="Enter Full Blood Count Test"  required><br><br>
        <input class="nav"type="text"  id="StaffName" name="hepatitis" placeholder="Hepatitis Status"  required><br><br>
        <input class="nav"type="text"  id="allergy" name="allergy" placeholder="Allergy"  required><br><br>
