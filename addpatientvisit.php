...
<html lang="en">
  ...
  <body>
    ...
    <div class="navbar">
      ...
      <h2 style="margin-left: 100px;">Add Patient Visit</h2><br>

      <p class=" intro">Enter all necessary fields</p>

      <form id="visitForm"  action="addpatientvisitproc.php" method="GET">
        ...
        <input class="nav"type="text"  id="StaffName" name="StaffName" placeholder="Enter Staff Full Name"  required><br><br>
        <input class="nav" type="number" id="staffnumber" name="staffnumber" placeholder="Enter Staff ID"  required><br><br>
        <input class="nav"type="datetime-local"   id="patientDate" name="patientDate" placeholder="Enter Visit Date"  required><br><br>
        <textarea class="nava"type="text" id="symptoms" name="symptoms" placeholder="Enter  Symptoms"  ></textarea><br><br>
        <textarea class="nava"type="text" id="disease" name="disease" placeholder="Enter Disease Name"  ></textarea><br><br>
        <textarea class="nava"type="text" id="prescription" name="prescription" placeholder="Enter Prescriptions" ></textarea><br><br>
